...
SP500_CORE = [
    ...
    "DE", "DG", "DGX", "DHI", "DHR", "DIS", "DLR", "DLTR", "DOV", "DOW",
    ...
    "FE", "FFIV", "FIS", "FISV", "FITB", "FMC", "FOX", "FOXA", "FRT", "FTNT",
    "FTV", "GD", "GE", "GILD", "GIS", "GL", "GLW", "GM", "GNRC", "GOOG",
    ...
    "INVH", "IP", "IQV", "IR", "IRM", "ISRG", "IT", "ITW", "IVZ", "J",
    "JBHT", "JCI", "JKHY", "JNJ", "JPM", "KDP", "KEY", "KEYS", "KHC", "KIM",
...
POPULAR_OPTIONS = [
    "ABNB", "ACHR", "AI", "AFRM", "AG", "AMC", "ANNA", "APLD", "APP", "ARM",
    "ARQQ", "BABA", "BLDP", "BNGO", "BTBT", "BYND", "CELH", "CHPT", "CIFR", "CLSK",
    "COIN", "CRWD", "CVNA", "DASH", "DDOG", "DFLI", "DNA", "DNUT", "DOCS", "DOCU",
    "DKNG", "DTST", "DUOL", "ENPH", "ENVX", "EQX", "EVGO", "FCEL", "FLNC", "FSLY",
    "FUBO", "FUTU", "GENI", "GEVO", "GME", "GNRC", "GRAB", "GRPN", "HIMS", "HOOD",
    "HUT", "HYMC", "IONQ", "IQ", "IOVA", "JD", "JOBY", "KGC", "KVUE", "LAZR",
    "LCID", "LI", "LMND", "LOVE", "LQDA", "LYFT", "MARA", "MELI", "MGNI", "MNDY",
    "MSTR", "MQ", "NET", "NIO", "NKLA", "NU", "NVAX", "OKTA", "OPEN", "OPK",
    "ORGN", "PANW", "PATH", "PAYO", "PCOR", "PINS", "PLTR", "PLUG", "PRCH", "QS",
    "QUBT", "RBLX", "RDDT", "RGTI", "RIOT", "RIVN", "ROKU", "RSKD", "RUM", "S",
    "SE", "SEDG", "SHOP", "SKLZ", "SNAP", "SNOW", "SOFI", "SOUN", "SPOT", "STNE",
    "TASK", "TGTX", "TLRY", "TRIP", "TTD", "TWLO", "U", "UBER", "UPST", "URBN",
    "VRM", "VUZI", "W", "WDAY", "XPEV", "ZM", "ZS",
]

# ETFs with high options volume
OPTIONABLE_ETFS = [
    "ARKG", "ARKK", "BITO", "DIA", "EEM", "EFA", "ERX", "ETHE", "EWJ", "EWZ",
    "FXI", "GBTC", "GDX", "GDXJ", "GLD", "HYG", "IBB", "IEF", "IGV", "IJR",
    "IVV", "IWD", "IWF", "IWM", "IWN", "IYR", "JNUG", "KRE", "LQD", "MDY",
    "MSOS", "OIH", "ONEQ", "QQQ", "QUAL", "RSP", "SCHD", "SLV", "SMH", "SOXX",
    "SOXL", "SOXS", "SPXL", "SPXS", "SPY", "SQQQ", "TLT", "TNA", "TQQQ", "USO",
    "UVXY", "VGK", "VNQ", "VO", "VOO", "VTI", "VTV", "VWO", "VXX", "XBI",
    "XHB", "XLC", "XLE", "XLF", "XLI", "XLK", "XLP", "XLU", "XLV", "XLY",
    "XME", "XOP", "XRT",
]
